                  ...
                  SizedBox(
                    ...
                    child: TextFormField(
                      onChanged: (value) {
                        ...
                        for (var item in productsController.showAllProducts) {
                          if (item.title
                              .toLowerCase()
                              .contains(searchProducts.text.toLowerCase())) {
                            empty.add(item);
                          }
                        }
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: 'Spider Man: Home Comming',
                          ...
                          onTap: () {
                            Get.to(
                              ProductDetailsScreen(
                                ...
                                ratings: productDetails.rating.rate.toString(),
                                totalVotes:
